...
| 5 | clean commit, push, remote file/visibility verification | pending | remote `main`, GitHub UI, Actions |
| 6 | fresh public clone, install, offline CI, bounded SEO/GEO smoke | pending | release verification report |
